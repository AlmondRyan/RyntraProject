...
void ArgumentParser::printHelp(const std::string& programName) {
    ...
    std::cout << "  " << programName << " -i hello.rynt -o hello" << std::endl;
    std::cout << "  " << programName << " -i program.rynt -o program --show-ast" << std::endl;
    std::cout << "  " << programName << " -i test.rynt -o test --show-token --show-llvm-ir" << std::endl;
    std::cout << std::endl;
    std::cout << "Target Platform: x86_64-windows-msvc" << std::endl;
